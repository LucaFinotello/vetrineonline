            ...
            else
            {
                ...
                <form action="test.php" method="POST" >
                    <div class="prenotazione">
                        Data: <input class="inputBottom" name="giorno" id='data' type="text" value="<?php echo date('d/m/Y',$riga["giorno"])?>"><br>
                        Fascia: <input class="inputBottom" name="fascia" id='fascia' type="text" readonly value="<?php echo $riga["fascia"]?>"><br>
                        Turno: <input class="inputBottom" name="turno" id="turno" type="text" readonly value="<?php echo $riga["turnoInizio"]?> - <?php echo $riga["turno"]?>"><br>
                        Stanza: <input class="inputBottom" name="stanza" id='stanza' type="text" value="<?php echo substr($riga["stanza"], 2)?>"><br><br>
